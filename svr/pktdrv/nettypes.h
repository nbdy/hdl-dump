...
#define IS_NT_WORD(src, val) \
  (((src)[0] == (((val) >> 8) & 0xff)) && ((src)[1] == (((val) >> 0) & 0xff)))

#define NT_WORD_EQ(w1, w2) \
  ((w1)[0] == (w2)[0] && (w1)[1] == (w2)[1])

#define GET_NT_WORD(src) \
  ((((u16) (src)[0]) << 8) | (((u16) (src)[1]) << 0))
...
#define IS_NT_DWORD(src, val) \
  (((src)[0] == (((val) >> 24) & 0xff)) && ((src)[1] == (((val) >> 16) & 0xff)) && ((src)[2] == (((val) >> 8) & 0xff)) && ((src)[3] == (((val) >> 0) & 0xff)))

#define NT_DWORD_EQ(dw1, dw2) \
  ((dw1)[0] == (dw2)[0] && (dw1)[1] == (dw2)[1] && (dw1)[2] == (dw2)[2] && (dw1)[3] == (dw2)[3])

#define GET_NT_DWORD(src) \
  ((((u32) (src)[0]) << 24) | (((u32) (src)[1]) << 16) | (((u32) (src)[2]) << 8) | (((u32) (src)[3]) << 0))
